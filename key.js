...
var_dump(publicKey.toString("base64"));
var_dump(privateKey.toString("base64"));
...
console.log("encrypted data raw: ", encryptedData);
...
console.log("decrypted data raw: ", decryptedData);
